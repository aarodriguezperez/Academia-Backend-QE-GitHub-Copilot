...
![Preparación · Checklist de entrada](./evidencias/00-preparacion-checklist.png)
...
![Preparación · Suite inicial con 77 tests](./evidencias/01-preparacion-suite-77.png)
...
![MP-1 · VS Code y GitHub Copilot Chat](./evidencias/02-mp1-vscode-version.png)
...
![MP-2 · Cuenta de GitHub en VS Code](./evidencias/03-mp2-cuenta-github.png)
...
![MP-2 · Copilot Pro activo](./evidencias/04-mp2-copilot-pro.png)
...
![MP-3 · Sugerencia aceptada en `TaskService`](./evidencias/05-mp3-autocompletado-aceptado.png)
...
![MP-3 · Archivo restaurado y repositorio limpio](./evidencias/06-mp3-restauracion-limpia.png)
...
![MP-4 · Respuesta de Ask](./evidencias/07-mp4-ask-respuesta.png)
...
![MP-4 · Verificación independiente de `estaVencida`](./evidencias/08-mp4-verificacion-esta-vencida.png)
...
![MP-5 · Solicitud de permiso para ejecutar Maven](./evidencias/09-mp5-aprobacion-maven.png)

Después de aprobarlo, el agente confirmó que Maven terminó correctamente con código de salida `0`.

![MP-5 · Agent ejecuta la suite](./evidencias/10-mp5-agent-suite-pasa.png)
...
![MP-5 · Repositorio sin modificaciones](./evidencias/11-mp5-repo-sin-cambios.png)
...
![MP-6 · Instrucciones del proyecto disponibles](./evidencias/12-mp6-instrucciones-vscode.png)
...
![MP-7 · Skills reconocidas por VS Code](./evidencias/13-mp7-skills-vscode.png)
...
![MP-8 · El revisor no puede editar](./evidencias/14-mp8-revisor-no-edita.png)
...
![MP-8 · El repositorio permanece limpio](./evidencias/15-mp8-repo-sin-cambios.png)
...
![MP-9 · Configuración MCP de VS Code](./evidencias/16-mp9-mcp-json.png)
...
![MP-9 · Los tres servidores MCP respondieron](./evidencias/17-mp9-servidores-mcp-ok.png)
...
![MP-10 · TaskFlow MCP en ejecución](./evidencias/18-mp10-taskflow-running-3-tools.png)
...
![MP-10 · Llamada real a `listar_tareas_vencidas`](./evidencias/19-mp10-llamada-listar-vencidas.png)
...
![MP-10 · Resultado MCP comprobado mediante REST](./evidencias/20-mp10-verificacion-rest-id7.png)

Finalmente `.vscode/mcp.json` fue agregado al repositorio y publicado en `main`.

![MP-10 · Configuración MCP versionada](./evidencias/21-mp10-mcp-json-commit-push.png)
...
![PF-1 · Rama `feature/progress` y spec](./evidencias/22-pf1-feature-progress.png)
...
![PF-2 · Implementación y consumo de AI Credits](./evidencias/23-pf2-implementacion-creditos.png)
...
![PF-2 · Validación mecánica de la implementación](./evidencias/24-pf2-validacion-mecanica.png)
...
![PF-2 · Transcript limpio y sin secretos](./evidencias/25-pf2-transcript-sin-secretos.png)
...
![PF-3 · Revisión del agente y veredicto APROBADO](./evidencias/26-pf3-revisor-aprobado.png)
...
![PF-3 · Revisión confirmada sin modificar `src`](./evidencias/27-pf3-veredicto-y-status.png)
...
![PF-5 · Casos de progress integrados en el verificador](./evidencias/28-pf5-casos-progress-en-verificador.png)
...
![PF-5 · Verificación REST 12/12 OK](./evidencias/29-pf5-verificacion-12de12.png)
...
![PF-6 · Pull Request del proyecto final](./evidencias/30-pf6-pr-abierto.png)
...
![PF-6 · Import no usado comprobado](./evidencias/31-pf6-hallazgo-import-no-usado.png)
...
![PF-6 · Hallazgo de seguridad comprobado](./evidencias/32-pf6-hallazgo-seguridad-comprobado.png)
...
![PF-6 · Cobertura JSON contrastada con el DTO](./evidencias/33-pf6-hallazgo-json-comprobado.png)
...
![PF-6 · Comentarios válidos documentados](./evidencias/34-pf6-code-review-md.png)
...
![PF-6 · Correcciones aplicadas y créditos utilizados](./evidencias/35-pf6-correccion-creditos.png)
...
![PF-6 · Validación final con 79 tests](./evidencias/36-pf6-validacion-79-tests.png)

Finalmente el PR fue mergeado a `main`.

![PF-6 · Pull Request mergeado](./evidencias/37-pf6-pr-mergeado.png)
...
![PF-7 · README sin placeholders pendientes](./evidencias/38-pf7-readme-sin-placeholders.png)
...
![PF-7 · Entrega final dentro de `semana6/`](./evidencias/39-pf7-semana6-en-github.png)
